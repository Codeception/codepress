...
module.exports = {
    ...
    cli: {
        /**
         * Tell frontend to start cli
         * @param {*} data 
         */
        start(data) { 
            socket.emit('cli.start', data);
        },
        /**
         * Tell frontend to close cli
         */
        stop() {
        ...
        /**
         * Show command execution error in frontend
         * @param {*} err 
         */
        error(err) {
            socket.emit('cli.error', err);
        },
        /**
         ...
         */
        onLine(callback) {
            socket.on('cli.line', callback);
        },
        /**
         * Handle close event from frontend
         * @param {*} callback 
         */
        onClose(callback) {
            socket.on('cli.close', callback)            
        }
    }
}